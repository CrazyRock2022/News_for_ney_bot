...
async def on_startup(_):
    ...
    await bot.delete_webhook(drop_pending_updates=True)  # Очищаем старые вебхуки

    # Убираем возможность установки нового вебхука, используем только polling
    await bot.set_webhook(url='')  # Убираем вебхук из кода, чтобы точно не было установлено
