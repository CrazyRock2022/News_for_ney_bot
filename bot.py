...
async def is_relevant(title, summary, tags=None, category=None, content=None):
    ...
    prompt = (
        ...
        f"если она касается криптовалют или стейблкоинов или цифрового рубля или Российского рубля или ставки ЦБ РФ или экономики Кыргызстана или финансовых регуляторов, "
